...
compile_translations: ## compile translation files, outputting .po files for each supported language
	cd platform_plugin_elm_credentials && i18n_tool generate

detect_changed_source_translations:
	cd platform_plugin_elm_credentials && i18n_tool changed
...
pull_translations:
	find platform_plugin_elm_credentials/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/platform-plugin-elm-credentials/platform_plugin_elm_credentials/conf/locale:platform_plugin_elm_credentials/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd platform_plugin_elm_credentials && i18n_tool dummy
