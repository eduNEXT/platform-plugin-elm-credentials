...
"""
platform-plugin-elm-credentials documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform-plugin-elm-credentials',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/platform-plugin-elm-credentials",
...
#
# html_title = 'platform-plugin-elm-credentials v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Open edx plugin that includes API to generate JSON files in ELMv3',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_elm_credentials'),
                os.path.join(root_path, 'platform_plugin_elm_credentials/migrations')])
