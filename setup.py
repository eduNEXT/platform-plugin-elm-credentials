#!/usr/bin/env python
"""
Package metadata for platform_plugin_elm_credentials.
"""
import os
import re
import sys
...
VERSION = get_version('platform_plugin_elm_credentials', '__init__.py')
...
setup(
    name='platform-plugin-elm-credentials',
    version=VERSION,
    description="""Open edx plugin that includes API to generate JSON files in ELMv3""",
    long_description=README + '\n\n' + CHANGELOG,
    author='eduNEXT',
    author_email='technical@edunext.co',
    url='https://github.com/eduNEXT/platform-plugin-elm-credentials',
    packages=find_packages(
        include=['platform_plugin_elm_credentials', 'platform_plugin_elm_credentials.*'],
        exclude=["*tests"],
    ),
